...
:HTML_CONTAINER_CLASS: build
:END:
- You can now build your PCB, look at the picutre below and build your own PCB
[[./img/CloseFinal.jpg]]
[[./img/Eggtimerfinal.jpg]] 
- Once you have built the circuit, you will need to test it. 
- You will need to adjust the potentiometer to get the time you want.
- 3 mins = soft boiled
- 5 mins = medium
- 10 mins = hard boiled
** Badge It
